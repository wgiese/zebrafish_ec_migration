...
# zebrafish_ec_migration documentation build
...
from zebrafish_ec_migration import __version__ as release

# -- Project information -----------------------------------------------------

project = "zebrafish_ec_migration"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "zebrafish_ec_migrationdoc"
...
latex_documents = [
    (
        master_doc,
        "zebrafish_ec_migration.tex",
        "zebrafish_ec_migration Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "zebrafish_ec_migration",
        "Project zebrafish_ec_migration codebase.",
        "Data-Science",
    )
]
